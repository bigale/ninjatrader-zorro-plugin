...
#define MAX_CONTRACTS 36000 // max CONTRACTs in chain
...
typedef struct PERFORMANCE
{
	...
	var	vUlcer;				// max drawdown percent from previous peak
...
// trade parameters (r/w)
	...
	int	nMinTrades;		// Min # of trade for objective
	int	pad2[2];
...
// simulation/optimization parameters (r/w)
	...
	long	pad5[1];
	var	vPriceStep;		// minimum price difference for download
	long	pad51[2];
...
#define GET_CHAIN			63	// List of strikes and expirations
